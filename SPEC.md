# Gossip Trading — EF Hackathon Spec

## What It Is

An autonomous trading agent for Kalshi prediction markets that uses real-time news intelligence to find and exploit mispriced markets. The "gossip" is the news — the agent listens to the world's gossip, figures out what it means for prediction markets, and trades before the crowd catches up.
...
```python
AGENT_PROMPT = """
You are Gossip Trading, an autonomous prediction market trader.
